...
class SoapCall_DeletionRunItems extends PlentySoapCall {
	...
	public static function getInstance() {
		if (! isset ( self::$instance ) || ! (self::$instance instanceof SoapCall_DeletionRunItems)) {
			self::$instance = new SoapCall_DeletionRunItems();
		}
